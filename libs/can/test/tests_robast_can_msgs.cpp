...
//                 REQUIRE(can_signals[CAN_SIGNAL_DRAWER_CONTROLLER_ID].get_bit_start() == CAN_SIGNAL_DRAWER_CONTROLLER_ID_BIT_START);
//                 REQUIRE(can_signals[CAN_SIGNAL_DRAWER_CONTROLLER_ID].get_bit_length() == CAN_SIGNAL_DRAWER_CONTROLLER_ID_BIT_LENGTH);
//                 REQUIRE(can_signals[CAN_SIGNAL_DRAWER_CONTROLLER_ID].get_data() == data_drawer_controller_id);
...
//                 REQUIRE(can_signals[CAN_SIGNAL_DRAWER_CONTROLLER_ID].get_bit_start() == bit_start_drawer_id);
//                 REQUIRE(can_signals[CAN_SIGNAL_DRAWER_CONTROLLER_ID].get_bit_length() == bit_length_drawer_id);
//                 REQUIRE(can_signals[CAN_SIGNAL_DRAWER_CONTROLLER_ID].get_data() == data_drawer_controller_id);
