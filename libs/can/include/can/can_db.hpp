   ...
   public:
    ...
    const std::vector<CanMessage> can_messages = {
      ...
      CanMessage(
        ...
        {CanSignal(CAN_SIGNAL_MODULE_ID_BIT_START, CAN_SIGNAL_MODULE_ID_BIT_LENGTH, 0),
         CanSignal(CAN_SIGNAL_SINGLE_LED_STATE_INDEX_BIT_START, CAN_SIGNAL_SINGLE_LED_STATE_INDEX_BIT_LENGTH, 0),
         ...
         CanSignal(CAN_SIGNAL_SINGLE_LED_STATE_BRIGHTNESS_BIT_START, CAN_SIGNAL_LED_BRIGHTNESS_BIT_LENGTH, 0)}),
    };
  };
}   // namespace robast_can_msgs
