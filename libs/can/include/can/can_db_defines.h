...
namespace robast_can_msgs
{
    ...
    *********************************************************************************************************/
    ...
    #define CAN_SIGNAL_MODULE_ID 0
    #define CAN_SIGNAL_DRAWER_ID 1
    #define CAN_SIGNAL_DRAWER_GOTO_POSITION 2
    #define CAN_SIGNAL_DRAWER_SPEED_MODE 3
    ...
    *********************************************************************************************************/
    ...
    #define CAN_SIGNAL_DRAWER_ID_BIT_START 24
    #define CAN_SIGNAL_DRAWER_ID_BIT_LENGTH 2
    #define CAN_SIGNAL_DRAWER_GOTO_POSITION_BIT_START 26
    #define CAN_SIGNAL_DRAWER_GOTO_POSITION_BIT_LENGTH 8
    #define CAN_SIGNAL_DRAWER_SPEED_MODE_BIT_START 34
    #define CAN_SIGNAL_DRAWER_SPEED_MODE_BIT_LENGTH 3
    #define CAN_SIGNAL_DRAWER_STALL_GUARD_ENABLE_BIT_START 37
