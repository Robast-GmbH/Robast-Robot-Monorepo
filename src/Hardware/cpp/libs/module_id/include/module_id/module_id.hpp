...
namespace module_id
{
  ...
  {
    MANUAL_DRAWER_10x40 = module_category::TRANSPORTATION
    ...
    MANUAL_DRAWER_20x40 = module_category::TRANSPORTATION
                            << (bit_length::MODULE_UNIQUE_ID_BIT_LENGTH + bit_length::SUBMODULE_TYPE_BIT_LENGTH) |
                          module_type::transportation::MANUAL_DRAWER_20x40 << bit_length::MODULE_UNIQUE_ID_BIT_LENGTH,
    MANUAL_DRAWER_30x40 = module_category::TRANSPORTATION
                            << (bit_length::MODULE_UNIQUE_ID_BIT_LENGTH + bit_length::SUBMODULE_TYPE_BIT_LENGTH) |
                          module_type::transportation::MANUAL_DRAWER_30x40 << bit_length::MODULE_UNIQUE_ID_BIT_LENGTH,
    E_DRAWER_10x40 = module_category::TRANSPORTATION
                       << (bit_length::MODULE_UNIQUE_ID_BIT_LENGTH + bit_length::SUBMODULE_TYPE_BIT_LENGTH) |
                     module_type::transportation::E_DRAWER_10x40 << bit_length::MODULE_UNIQUE_ID_BIT_LENGTH,
    PARTIAL_DRAWER_10x40x8 = module_category::TRANSPORTATION
                               << (bit_length::MODULE_UNIQUE_ID_BIT_LENGTH + bit_length::SUBMODULE_TYPE_BIT_LENGTH) |
                             module_type::transportation::PARTIAL_DRAWER_10x40x8
                               << bit_length::MODULE_UNIQUE_ID_BIT_LENGTH,
    DINNER_TRAYS = module_category::TRANSPORTATION
                     << (bit_length::MODULE_UNIQUE_ID_BIT_LENGTH + bit_length::SUBMODULE_TYPE_BIT_LENGTH) |
                   module_type::transportation::DINNER_TRAYS << bit_length::MODULE_UNIQUE_ID_BIT_LENGTH,
    SURGERY_TOOLS = module_category::TRANSPORTATION
                      << (bit_length::MODULE_UNIQUE_ID_BIT_LENGTH + bit_length::SUBMODULE_TYPE_BIT_LENGTH) |
                    module_type::transportation::SURGERY_TOOLS << bit_length::MODULE_UNIQUE_ID_BIT_LENGTH,
    BASE_LED_CONTROLLER = module_category::VISUALIZATION
                            << (bit_length::MODULE_UNIQUE_ID_BIT_LENGTH + bit_length::SUBMODULE_TYPE_BIT_LENGTH) |
                          module_type::visualization::BASE_LED_CONTROLLER << bit_length::MODULE_UNIQUE_ID_BIT_LENGTH
  };
