...
namespace drawer_controller
{
    class ElectricalDrawerConfigs
    {
        public:
            ...
            void set_drawer_push_in_threshold_in_percent_of_max_extent(const float threshold_in_percent_of_max_extent);
            void set_drawer_push_in_encoder_check_interval_ms(const uint32_t encoder_check_interval_ms);
        ...
        private:
            ...
            float _push_in_threshold_in_percent_of_max_extent;
            uint32_t _push_in_encoder_check_interval_ms;
