...
namespace drawer_controller
{
  ...
  void ConfigManager::set_config(const uint8_t config_id, const uint32_t config_value)
  {
    switch (config_id)
    {
      ...
      case module_config::drawer::PUSH_IN_AUTO_CLOSE_STALL_GUARD_VALUE:
        _drawer_configs->set_drawer_push_in_auto_close_stall_guard_value(
          static_cast<
            module_config::ModuleConfigDataType<module_config::drawer::PUSH_IN_AUTO_CLOSE_STALL_GUARD_VALUE>::type>(
            config_value));
        break;
  ...
  void ConfigManager::set_default_drawer_configs()
  {
    ...
    set_config(module_config::drawer::PUSH_IN_AUTO_CLOSE_STALL_GUARD_VALUE,
               static_cast<uint32_t>(module_config::ModuleConfigDataType<
                                     module_config::drawer::PUSH_IN_AUTO_CLOSE_STALL_GUARD_VALUE>::default_value));
