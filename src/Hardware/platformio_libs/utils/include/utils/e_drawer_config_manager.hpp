#ifndef UTILS_E_DRAWER_CONFIG_MANAGER_HPP
#define UTILS_E_DRAWER_CONFIG_MANAGER_HPP
...
namespace utils
{
  class EDrawerConfigManager : public BaseConfigManager
  {
   public:
...
#endif   // UTILS_E_DRAWER_CONFIG_MANAGER_HPP
