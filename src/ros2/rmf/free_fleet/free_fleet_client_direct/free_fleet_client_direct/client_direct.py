...
class free_fleet_client_direct(Node):
    ...
    def __init__(self):
       ...
       #nav
        ...
        self.battery_subscriber= self.create_subscription(BatteryState, "/robot/robotnik_base_hw/robotnik_battery_broadcaster/battery", self.publish_battery_data, 10)
