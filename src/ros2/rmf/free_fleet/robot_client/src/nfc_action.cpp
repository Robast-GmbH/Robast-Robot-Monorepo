...
namespace rmf_robot_client
{
  ...
  void NFCAction::start_writing_procedure()
  {
    ...
    send_goal_options.goal_response_callback =
        std::bind(&NFCAction::goal_response_callback, this, std::placeholders::_1);
    send_goal_options.feedback_callback =
        std::bind(&NFCAction::feedback_callback, this, std::placeholders::_1, std::placeholders::_2);
  ...
  void NFCAction::feedback_callback(GoalHandleCreateUserNfcTag::SharedPtr,
