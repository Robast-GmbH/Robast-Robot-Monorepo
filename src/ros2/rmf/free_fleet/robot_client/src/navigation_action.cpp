...
: Action(task_id, step, ros_node)
{
  ...
  navigate_to_pose_client_ = rclcpp_action::create_client<NavigateToPose>(
    ros_node, ros_node_->get_parameter(
      "nav2_navigation_to_pose_action_topic").as_string());
}
...
void NavigationAction::start_navigation()
{
  ...
  send_goal_options.goal_response_callback = std::bind(
    &NavigationAction::goal_response_callback,
    this, std::placeholders::_1);
  send_goal_options.feedback_callback = std::bind(
    &NavigationAction::feedback_callback, this,
    std::placeholders::_1, std::placeholders::_2);
  send_goal_options.result_callback = std::bind(
    &NavigationAction::result_callback, this,
    std::placeholders::_1);
...
void NavigationAction::goal_response_callback(
...
void NavigationAction::feedback_callback(
