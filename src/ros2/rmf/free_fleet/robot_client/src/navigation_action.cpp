...
namespace rmf_robot_client
{
  ...
  void NavigationAction::start_navigation()
  {
    ...
    send_goal_options.goal_response_callback =
        std::bind(&NavigationAction::goal_response_callback, this, std::placeholders::_1);
    send_goal_options.feedback_callback =
        std::bind(&NavigationAction::feedback_callback, this, std::placeholders::_1, std::placeholders::_2);
  ...
  void NavigationAction::feedback_callback(GoalHandleNavigateToPose::SharedPtr,
  ...
  void NavigationAction::result_callback(const GoalHandleNavigateToPose::WrappedResult&)
  {
