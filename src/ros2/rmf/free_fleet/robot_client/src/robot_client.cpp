...
namespace rmf_robot_client
{
  ...
  void RobotClient::start_receive_tasks()
  {
    ...
    setting_subscriber = this->create_subscription<FleetDataSettingRequest>(this->get_parameter("fleet_communication_setting_topic").as_string(), qos, std::bind(&RobotClient::receive_settings, this, std::placeholders::_1));
