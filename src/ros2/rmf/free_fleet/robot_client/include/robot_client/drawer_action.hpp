#ifndef ROBOT_CLIENT__DRAWER_ACTION_HPP_
#define ROBOT_CLIENT__DRAWER_ACTION_HPP_
...
public:
  DrawerAction(
    ...
    std::shared_ptr<std::map<std::string, DrawerState>> drawers, int drawer_int, int module_id,
    bool is_edrawer, std::vector<uint16_t> autorised_user);
...
#endif  // ROBOT_CLIENT__DRAWER_ACTION_HPP_
