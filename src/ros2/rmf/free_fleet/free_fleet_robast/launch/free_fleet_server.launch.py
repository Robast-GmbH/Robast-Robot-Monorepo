...
def generate_launch_description():
    ...
    ros2_rmf_mode_request_topic_cmd = launch.actions.DeclareLaunchArgument(
        ...
        description='rmf_topic on which the mode of operation of the robot is sent like start stop is sent')
    ...
    start_free_fleet_server_cmd = Node(
                ...
                parameters=[{"fleet_name": fleet_yaml["fleet_name"]},
                            ...
                            {"dds_destination_request_topic": fleet_yaml["dds_destination_request_topic"]},
    ...
    ## start a server component to provide a custom rest interface for rmf and to extend the functionality with custom features.  
