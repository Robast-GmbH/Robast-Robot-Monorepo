...
class RestInterface():
    ...
    def handle_robot_update(self,
        ...
        message = self.fill_robot_status_msg(robot_name,
                                             "ROBAST",
                                             task_id=task_id,
                                             x_pose=x_pose,
                                             y_pose=y_pose,
        ...
        try:
            sender.post(url=self.response_api+"/robots/status",
    ...
    def handle_drawer_status_change(self, task_id, module_id, drawer_id, status):
        ...
        sender = requests.Session()
        sender.post(url=self.response_api+"/robots/modules/status",
                    data=json.dumps(message),
                    verify=False)
