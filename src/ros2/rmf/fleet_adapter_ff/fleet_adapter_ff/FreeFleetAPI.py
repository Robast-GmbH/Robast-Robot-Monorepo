...
class freeFleetAPI:
    def __init__(self, fleet_name: str, prefix: str, responce_interval:float, node: rclpy.node.Node):
        self.prefix = prefix
        ...
        self.publisher_mode_request = self.ros_node.create_publisher(ModeRequest, '/robot_mode_requests', 10)
        self.publisher_destination_request = self.ros_node.create_publisher(DestinationRequest, '/robot_destination_requests', 10)
        self.publisher_Path_request = self.ros_node.create_publisher(PathRequest, '/robot_path_requests', 10)
