...
namespace robast
{
    TestNFCGate::TestNFCGate(serial_helper::ISerialHelper* serial_connector, db::IDBHelper* db_connector ):NFCGate()
    {
    ...
    TestNFCGate::TestNFCGate() :NFCGate()
    {
        ...
        NFCGate::db_conncetor_ = new db::MockPostgreSqlHelper(validUserList);
    }
