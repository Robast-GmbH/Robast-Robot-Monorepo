...
//       //       THEN(
//       //           "The reader returns the scanned key, indecates that a Key has been found and on the serial
//       connection
//       //           the " "a NFC login message followed by a Read Message was send in the reading process to get the
//       data
//       //           from the " "card")
//       //       {
//       //         std::string key;
