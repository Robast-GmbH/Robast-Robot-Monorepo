...
namespace robast
{
  DrawerManager::DrawerManager(): Node("drawer_manager_Node")
  {
    ...
    this->drawers_info_server = this->create_service<ShelfSetupInfo>("get_module_setup", std::bind(&DrawerManager::get_shelf_setup,this, std::placeholders::_1, std::placeholders::_2));
  ...
  rclcpp_action::GoalResponse DrawerManager::drawer_interaction_goal_callback( const rclcpp_action::GoalUUID & uuid, std::shared_ptr<const DrawerInteraction::Goal> goal)
  {
    (void) uuid;
    (void) goal;
  ...
  rclcpp_action::CancelResponse DrawerManager::drawer_interaction_cancel_callback(const std::shared_ptr<GoalHandleDrawerInteraction> goal_handle)
  {
    (void) goal_handle;
  ...
  void DrawerManager::drawer_interaction_accepted_callback(const std::shared_ptr<GoalHandleDrawerInteraction> goal_handle)
  {
  ...
  DrawerManager::AuthenticateUserResultHandle DrawerManager::request_user_authentication(bool loading, std::vector<std::string> load_keys, std::vector<std::string> drop_of_keys)
  {    
    // NFC Reader
    ...
    send_goal_options.goal_response_callback = std::bind(&DrawerManager::authentication_goal_response_callback, this, std::placeholders::_1);
    send_goal_options.feedback_callback = std::bind(&DrawerManager::authentication_feedback_callback, this, std::placeholders::_1, std::placeholders:: _2);
  ...
  DrawerManager::DrawerUserAccessResultHandle DrawerManager::request_drawer_user_access(DrawerAddress drawer_address)
  {
    ...
    send_goal_options.goal_response_callback = std::bind(&DrawerManager::open_drawer_goal_response_callback, this, std::placeholders::_1);
    send_goal_options.feedback_callback = std::bind(&DrawerManager::open_drawer_feedback_callback, this, std::placeholders::_1, std::placeholders:: _2);
