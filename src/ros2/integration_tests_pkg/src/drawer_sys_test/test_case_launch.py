...
def generate_launch_description():
    ...
    gazebo_trajectory_executor_dir = get_package_share_directory('gazebo_trajectory_executor')
    ...
    gazebo_trajectory_executor_arguments = {
    ...
    contoller_manager_sim_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(gazebo_trajectory_executor_dir, 'launch', 'gazebo_trajectory_executor_launch.py')), 
                                      launch_arguments=gazebo_trajectory_executor_arguments)
