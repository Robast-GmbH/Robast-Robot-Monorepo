...
def generate_launch_description():
    ...
    declare_slam_toolbox_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            nav_bringup_dir, "config", "slam_toolbox_params_offline.yaml"
        ),
    ...
    declare_slam_posegraph_file_cmd = DeclareLaunchArgument(
        "slam_posegraph",
        default_value=os.path.join(nav_bringup_dir, "maps", "5OG", "5OG"),
    ...
    declare_amcl_toolbox_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(nav_bringup_dir, "launch", "amcl_launch.py"),
