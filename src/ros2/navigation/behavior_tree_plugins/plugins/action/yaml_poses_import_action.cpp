...
namespace nav2_behavior_tree
{
  ...
  ImportYamlPosesAction::ImportYamlPosesAction(const std::string& xml_tag_name,
...
BT_REGISTER_NODES(factory)
{
  ...
  {
    return std::make_unique<nav2_behavior_tree::ImportYamlPosesAction>(name, "yaml_poses_importer", config);
  };

  factory.registerBuilder<nav2_behavior_tree::ImportYamlPosesAction>("ImportYamlPosesAction", builder);
}
