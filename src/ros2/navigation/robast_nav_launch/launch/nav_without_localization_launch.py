...
def generate_launch_description():
    ...
    recoveries_params_yaml = os.path.join(
        get_package_share_directory("robast_nav_launch"),
        config_directory,
        "nav_params",
    ...
    recoveries_launch_file = os.path.join(
        robast_nav_launch_dir, "launch", "recoveries_launch.py"
    )
    robast_nav_interim_goal_dir = get_package_share_directory("robast_nav_interim_goal")
    interim_goal_launch_file = os.path.join(
        robast_nav_interim_goal_dir, "launch", "interim_goal_launch.py"
    )
    ...
    nav2_params_yaml_cmd = DeclareLaunchArgument(
        "nav2_params_yaml",
