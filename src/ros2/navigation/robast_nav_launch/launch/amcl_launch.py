...
def generate_launch_description():
    ...
    if is_simulation:
        map_file_yaml = os.path.join(
            get_package_share_directory("robast_nav_launch"), "maps", "5OG", "5OG.yaml"
        )
    else:
        map_file_yaml = os.path.join(
    ...
    remappings_amcl = [("/tf", "tf"), ("/tf_static", "tf_static")]

    remappings_map_server = [("/tf", "tf"), ("/tf_static", "tf_static")]
