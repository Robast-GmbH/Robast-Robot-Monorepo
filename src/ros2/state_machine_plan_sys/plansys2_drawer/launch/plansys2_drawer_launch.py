...
def generate_launch_description():
    ...
    plansys2_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
          'model_file': example_dir + '/pddl/drawer.pddl',
          'namespace': namespace
          }.items())
    ...
    ld.add_action(drawer_close_cmd)
    ld.add_action(drawer_lock_cmd)
    ld.add_action(drawer_unlock_cmd)
    ld.add_action(drawer_open_charge_cmd)
