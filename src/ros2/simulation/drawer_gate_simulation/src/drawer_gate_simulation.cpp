...
namespace drawer_gate_simulation
{
  ...
  {
    RCLCPP_INFO(this->get_logger(), "Sending send_drawer_feedback with drawer_controller_id: '%i'",
  ...
  void DrawerSimulation::move_drawer_in_simulation_to_target_pose(MoveGroupInterface *move_group_interface,
  ...
  void DrawerSimulation::open_drawer_in_simulation(MoveGroupInterface *move_group_interface,
                                                                       ...
                                                                       const float target_pose)
  {
    ...
    t.async_wait(boost::bind(&DrawerSimulation::move_drawer_in_simulation_to_target_pose, this, move_group_interface,
                             drawer_address, target_pose));
    io.run();
  }
  ...
  void DrawerSimulation::open_drawer_topic_callback(const DrawerAddress &msg)
  {
    ...
    auto move_group_interface =
        MoveGroupInterface(this->get_shared_pointer_of_node(), this->moveit2_planning_group_name_);
    ...
    this->async_wait_until_closing_drawer_in_simulation(this->time_until_drawer_closes_automatically_,
                                                        &move_group_interface, drawer_address,
