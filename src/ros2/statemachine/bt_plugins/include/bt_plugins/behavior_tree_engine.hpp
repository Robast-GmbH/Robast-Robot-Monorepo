...
namespace statemachine
{
  ...
  /**
   * @enum drawer_behavior_tree::BtStatus
  ...
  /**
   * @class drawer_behavior_tree::BehaviorTreeEngine
  ...
  public:
    /**
     * @brief A constructor for drawer_behavior_tree::BehaviorTreeEngine
     ...
     * @return drawer_behavior_tree::BtStatus Status of BT execution
     */
    BtStatus run(
        BT::Tree *tree,
...
#endif // DRAWER_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_