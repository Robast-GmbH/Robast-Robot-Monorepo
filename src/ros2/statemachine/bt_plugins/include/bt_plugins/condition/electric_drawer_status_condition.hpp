...
{
  class ElectricDrawerStatusCondition
      : public BaseCompareCondition<communication_interfaces::msg::ElectricalDrawerStatus, uint8_t>
  {
   public:
    ElectricDrawerStatusCondition(const std::string &name, const BT::NodeConfig &config);
    static BT::PortsList providedPorts()
    {
      return {BT::InputPort<uint8_t>("target_value", "0"),
   ...
   protected:
    ...
    bool comparator(communication_interfaces::msg::ElectricalDrawerStatus last_message, uint8_t target_value) override;
