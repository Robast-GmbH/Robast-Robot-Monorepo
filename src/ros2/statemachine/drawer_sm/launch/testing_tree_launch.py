...
def generate_launch_description():
    ...
    declare_bt_config_params_cmd = DeclareLaunchArgument(
        'bt_config_params',
        default_value=os.path.join(bringup_dir, 'config', 'testing_tree_params.yaml'),
        description='path to the bt_params.yaml file')

    param_substitutions = {
        'bt_path': os.path.join(bringup_dir, 'trees', 'testing_tree.xml'),
        'trigger_topic': 'testing_tree_trigger'}
