...
#include "robast_msgs/action/authenticate_user.hpp"
...
namespace robast_drawer_manager
{
  ...
  private:
    ...
    void goal_response_callback(std::shared_future<rclcpp_action::ClientGoalHandle<robast_msgs::action::DrawerUserAccess>::SharedPtr> future);
    ...
    void open_drawer_result_callback(const rclcpp_action::ClientGoalHandle<robast_msgs::action::DrawerUserAccess>::WrappedResult & result)
