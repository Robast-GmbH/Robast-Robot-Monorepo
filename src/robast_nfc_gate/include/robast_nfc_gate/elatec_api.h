#ifndef ROBAST_NFC_GATE__ELATEC_API_HPP_
#define ROBAST_NFC_GATE__ELATEC_API_HPP_
...
#define BEEP_STANDART "0407646009F401F401"

#define NFC_LOGIN_MC(KEY, KEY_TYPE, SECTOR)  string("0B00") + string(KEY) + string(KEY_TYPE) + string(SECTOR)
#define NFC_LOGIN_MC_STANDART(SECTOR) string("0B00A0A1A2A3A4A500") + string(SECTOR)
