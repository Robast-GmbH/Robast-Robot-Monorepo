...
/////////////////////////////////////////////////
RandomMovePlugin::RandomMovePlugin()
{
}

/////////////////////////////////////////////////
void RandomMovePlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  this->sdf = _sdf;
  ...
  this->connections.push_back(event::Events::ConnectWorldUpdateBegin(
          std::bind(&RandomMovePlugin::OnUpdate, this, std::placeholders::_1)));
...
/////////////////////////////////////////////////
void RandomMovePlugin::ChooseNewTarget()
{
...
/////////////////////////////////////////////////
void RandomMovePlugin::HandleObstacles(ignition::math::Vector3d &_pos)
{
  for (unsigned int i = 0; i < this->world->ModelCount(); ++i)
  {
...
/////////////////////////////////////////////////
void RandomMovePlugin::OnUpdate(const common::UpdateInfo &_info)
{
  // Time delta
