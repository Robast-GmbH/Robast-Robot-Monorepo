#ifndef PATROL_PLUGIN_HPP_
#define PATROL_PLUGIN_HPP_
...
class PatrolPlugin : public gazebo::ModelPlugin
{
public:
  /// Constructor
  PatrolPlugin();
...
private:
  ...
  /// data members.
  std::unique_ptr<PatrolPluginPrivate> impl_;
};
}  // namespace gazebo_plugins

#endif  //PATROL_PLUGIN_HPP